...
Modules:
  daily_stats       — OAuth auth + today's health snapshot (sleep, HRV, steps, activities)
...
from garmin.daily_stats import fetch_daily_stats, initial_login, get_garmin_client
